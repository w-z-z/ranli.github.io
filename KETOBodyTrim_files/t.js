...
window.TrackJS = window.trackJs = (function(g, m, l) {
  ...
  u.prototype = {
      ...
      wrap: function(a) {
          ...
          var d = this;
          try {
              if (!c.isFunction(a) || c.hasOwn(a, "__trackjs__"))
                  return a;
              if (c.hasOwn(a, "__trackjs_state__"))
      ...
      wrapEventTarget: function(a) {
          var b = this;
          c.has(a, "addEventListener.call") && c.has(a, "removeEventListener.call") && (c.patch(a, "addEventListener", function(a) {
              return function(f, e, h, n) {
                  try {
                      c.has(e, "handleEvent") && (e.handleEvent = b.wrap(e.handleEvent))
                  } catch (k) {}
                  return a.call(this, f, b.wrap(e), h, n)
              }
          }),
  ...
  p.prototype = {
      ...
      defaults: {
          ...
          serialize: function(a) {
              ...
              if (c.isElement(a))
                  return b(a);
              if ("symbol" === typeof a)
                  return Symbol.prototype.toString.call(a);
              var d;
              try {
                  d = JSON.stringify(a, function(a, d) {
                      return d === l ? "undefined" : c.isNumber(d) && isNaN(d) ? "NaN" : c.isError(d) ? {
                          name: d.name,
                          message: d.message,
                          stack: d.stack
                      } : c.isElement(d) ? b(d) : d
      ...
      initCurrent: function(a) {
          ...
          if (this.validate(a, this.defaults, "[TrackJS] config", {}))
              return this.current = c.defaultsDeep({}, a, this.defaults),
              !0;
          this.current = c.defaultsDeep({}, this.defaults);
          return !1
      },
      setCurrent: function(a) {
          return this.validate(a, this.defaults, "[TrackJS] config", this.initOnly) ? (this.current = c.defaultsDeep({}, a, this.current),
          !0) : !1
      },
      removeEmpty: function(a) {
          for (var b in a)
              a.hasOwnProperty(b) && a[b] === l && delete a[b]
      },
          ...
          for (var c in a)
              if (a.hasOwnProperty(c))
                  if (b.hasOwnProperty(c)) {
                      var g = typeof b[c];
                      g !== typeof a[c] ? (console.warn(d + "." + c + ": property must be type " + g + "."),
                      e = !1) : "[object Array]" !== Object.prototype.toString.call(a[c]) || this.validateArray(a[c], b[c], d + "." + c) ? "[object Object]" === Object.prototype.toString.call(a[c]) ? e = this.validate(a[c], b[c], d + "." + c, f[c]) : f.hasOwnProperty(c) && (console.warn(d + "." + c + ": property cannot be set after load."),
                      e = !1) : e = !1
                  } else
                      console.warn(d + "." + c + ": property not supported."),
                      e = !1;
          return e
      },
      validateArray: function(a, b, d) {
          ...
          for (var e = 0; e < a.length; e++)
              c.contains(b, a[e]) || (console.warn(d + "[" + e + "]: invalid value: " + a[e] + "."),
              f = !1);
          return f
      }
  };
              ...
              (function(e) {
                  ...
                  a[e] = function() {
                      try {
                          ...
                          if (b[e])
                              if (c.isError(a[0]) && 1 === a.length)
                                  f.onError("console", a[0]);
                              else
                                  try {
  ...
  x.prototype = {
      all: function(a) {
          ...
          for (f = 0; f < this.appender.length; f++)
              (d = this.appender[f]) && d.category === a && b.push(d.value);
          return b
      },
      clear: function() {
  ...
  z.prototype = {
      ...
      watchFetch: function() {
          ...
          c.patch(g, "fetch", function(e) {
              return function(h, n) {
                  ...
                  var r = h instanceof Request ? h.url : h
                    , m = h instanceof Request ? h.method : (n || {}).method || "GET"
                    , r = a.escapeUrl(r)
                    , l = e.apply(g, arguments);
                  l.__trackjs_state__ = b.add("n", {
                      type: "fetch",
                      startedOn: c.isoNow(),
                      method: m,
                      url: c.truncate(r, 2E3)
                  });
                  return l.then(function(a) {
                      var e = b.get("n", l.__trackjs_state__);
                      if (e) {
                          c.defaults(e, {
                          ...
                          d.error && 400 <= a.status && (e = Error(e.statusCode + " " + e.statusText + ": " + e.method + " " + e.url),
                          e.stack = k,
                          f("ajax", e))
                      }
                      return a
                      ...
                      d.error && (f("ajax", {
                          name: a.name,
                          message: (a.message || "Failed") + ": " + e.method + " " + e.url,
                          stack: a.stack || k
                      }),
      ...
      watchNetworkObject: function(a) {
          var b = this
            , d = a.prototype.open
            , f = a.prototype.send;
          a.prototype.open = function(a, f) {
              var c = (f || "").toString();
              0 > c.indexOf("localhost:0") && (c = b.escapeUrl(c),
              this._trackJs = {
                  method: a,
                  url: c
              });
  ...
  t.prototype = {
      ...
      sendTrackerFault: function(a) {
          this.throttle(a) || (m.createElement("img").src = this.trackerFaultEndpoint(a))
      },
      sendUsage: function(a) {
          m.createElement("img").src = this.usageEndpoint(a)
      },
  ...
  var c = function() {
      function a(d, f, e, h) {
          ...
          c.forEach(f, function(f) {
              c.forEach(c.keys(f), function(c) {
                  null === f[c] || f[c] === l ? d[c] = f[c] : e && 10 > h && "[object Object]" === b(f[c]) ? (d[c] = d[c] || {},
                  a(d[c], [f[c]], e, h + 1)) : d.hasOwnProperty(c) || (d[c] = f[c])
              })
          });
          return d
      }
      ...
      return {
          ...
          afterDocumentLoad: function(a) {
              var b = !1;
              "complete" === m.readyState ? c.defer(a) : (c.addEventListenerSafe(m, "readystatechange", function() {
                  "complete" !== m.readyState || b || (c.defer(a),
                  b = !0)
              }),
              setTimeout(function() {
                  b || (c.defer(a),
  ...
  A.prototype = {
      ...
      writeVisitorEvent: function(a, b, d, c) {
          "password" === this.getElementType(a) && (d = l);
      ...
      getElementFromEvent: function(a) {
          return a.target || m.elementFromPoint(a.clientX, a.clientY)
      },
      ...
      getElementAttributes: function(a) {
          for (var b = {}, d = Math.min(a.attributes.length, 10), f = 0; f < d; f++) {
              ...
              c.contains(["data-value", "value"], e.name.toLowerCase()) || (b[e.name] = c.truncate(e.value, 100))
          }
          return b
      },
          ...
          c.patch(a, "onerror", function(a) {
              return function(c, e, h, g, k) {
                  try {
                      ...
                      k.name = k.name || "Error",
                      k.line = k.line || parseInt(h, 10) || null,
                      k.column = k.column || parseInt(g, 10) || null,
                      "[object Event]" !== Object.prototype.toString.call(c) || e ? k.file = k.file || b.serialize(e) : k.file = (c.target || {}).src,
                      b.onError("window", k)
                  } catch (l) {
                      b.onFault(l)
                  }
  ...
  C.prototype = {
      install: function(a) {
          try {
              ...
              if (!this.config.current.enabled)
              ...
              if (!this.util.isBrowserSupported())
                  return !1;
            ...
            , b = {
              ...
              attempt: function(b, f) {
                  try {
                      ...
                      throw a.onError("catch", g),
                      c.wrapError(g);
                  }
              },
              configure: function(b) {
                  return !a.hasInstalled && a.hasEnabled ? (a.warn("agent must be installed"),
                  !1) : a.config.setCurrent(b)
              },
              hash: "51ecabe1ba90963baf8fa4871290ae56947f95dd",
              ...
              watchAll: function(a) {
                  ...
                  for (e in a)
                      "function" !== typeof a[e] || c.contains(b, e) || (a[e] = this.watch(a[e], a));
                  return a
              }
          };
              ...
              if (this.hasInstalled && this.hasEnabled && c.isBrowserSupported())
                  try {
                      ...
                      -1 === f.message.indexOf("TrackJS Caught"))
                          if (b && -1 !== f.message.indexOf("Script error"))
                              b = !1;
                          else {
                              ...
                              if (!e.force)
                                  try {
                                      if (!this.config.current.onError(h, f))
                                          return
                                  } catch (l) {
                                      h.console.push({
                                          timestamp: this.util.isoNow(),
                              ...
                              (function() {
                                  ...
                                  for (var b = 0; a() && b < h.console.length; )
                                      h.console[b].message = c.truncate(h.console[b].message, 1E3),
                                      b++
                              }
                              )();
                              this.log.clear();
      ...
      onFault: function(a) {
          ...
          a = {
              ...
              v: "3.7.5",
              h: "51ecabe1ba90963baf8fa4871290ae56947f95dd",
              x: this.util.uuid()
          };
