...
!function (o) {
    ...
    o.modal = function (t, i) {
        ...
        constructor: o.modal, open: function () {
            ...
            this.$elm.trigger(o.modal.BEFORE_BLOCK, [this._ctx()]), this.$body.css({"overflow" : "hidden", "height" : "100%"}), this.$blocker = o('<div class="' + this.options.blockerClass + ' blocker current"></div>').appendTo(this.$body), n(), this.options.doFade && this.$blocker.css("opacity", 0).animate({opacity: 1}, this.options.fadeDuration), this.$elm.trigger(o.modal.BLOCK, [this._ctx()])
        }, unblock: function (t) {
            !t && this.options.doFade ? this.$blocker.fadeOut(this.options.fadeDuration, this.unblock.bind(this, !0)) : (this.$blocker.children().appendTo(this.$body), this.$blocker.remove(), this.$blocker = null, n(), o.modal.isActive() || this.$body.css({"overflow" : "", "height" : "auto"}))
        }, show: function () {
